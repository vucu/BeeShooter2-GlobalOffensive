...
// Custom: convert radians to degrees
...
// Custom: Calculate angle between u and v, in degrees
function angle_vec( u, v) {
	if ( u.length != v.length ) {
        throw "vector dimension mismatch";
    }
	
	var cos_theta = dot(u,v) / (length(u)*length(v));
	var theta = Math.acos(cos_theta);
	var angle = degrees(theta);
